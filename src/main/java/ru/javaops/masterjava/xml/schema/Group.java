...
public class Group {
    ...
    protected List<Group.Participant> participant;
     ...
     * {@link Group.Participant }
     * 
     * 
     */
    public List<Group.Participant> getParticipant() {
        if (participant == null) {
            participant = new ArrayList<Group.Participant>();
        }
